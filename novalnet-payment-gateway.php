...
if ( ! class_exists( 'Novalnet' ) ) :
	...
	if ( ! defined( 'NOVALNET_VERSION' ) ) {
		define( 'NOVALNET_VERSION', '12.3.0' );
	}
...
__('Novalnet payment plugin - WooCommerce', 'woocommerce-novalnet-gateway');
__('PCI compliant payment solution, covering a full scope of payment services and seamless integration for easy adaptability', 'woocommerce-novalnet-gateway' );
/**
