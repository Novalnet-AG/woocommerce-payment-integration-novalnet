		...
		wp_localize_script(
			...
			array(
				...
				'guarantee_text' => array(
					'novalnet_guaranteed_sepa' => __( 'Invoice with payment guarantee', 'woocommerce-novalnet-gateway' ),
					'novalnet_guaranteed_invoice' => __( 'Direct Debit SEPA with payment guarantee', 'woocommerce-novalnet-gateway' )
					),
			)
		);
	}
