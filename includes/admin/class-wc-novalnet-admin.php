	...
	public function admin_enqueue_scripts() {
		...
		wp_localize_script(
			...
			array(
				...
				'shopbased_subs_warning' => __( 'Are you sure you want to change the subscription management from Novalnet to shop based subscription for upcoming transactions ?' ),
				'server_subs_warning'    => __( 'Are you sure you want to change the subscription management from shop based subscription to Novalnet for upcoming transactions ? ' ),
			)
		);
	}
