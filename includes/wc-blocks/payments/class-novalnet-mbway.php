<?php
/**
 * Novalnet_Mbway payment method integration
 *
 * @since 12.7.0
...
/**
 * Novalnet_Mbway class.
 *
 * @extends AbstractPaymentMethodType
 */
final class Novalnet_Mbway extends AbstractPaymentMethodType {
	/**
	 * Payment method name defined by payment methods extending this class.
	 *
	 * @var string
	 */
	protected $name = 'novalnet_mbway';
