<?php
/**
 * Novalnet_Payconiq payment method integration
 *
 * @since 12.7.0
...
/**
 * Novalnet_Payconiq class.
 *
 * @extends AbstractPaymentMethodType
 */
final class Novalnet_Payconiq extends AbstractPaymentMethodType {
	/**
	 * Payment method name defined by payment methods extending this class.
	 *
	 * @var string
	 */
	protected $name = 'novalnet_payconiq';
