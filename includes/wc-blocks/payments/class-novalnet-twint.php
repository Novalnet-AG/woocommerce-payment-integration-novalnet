<?php
/**
 * Novalnet_Twint payment method integration
 *
 * @since 12.6.2
...
/**
 * Novalnet_Twint class.
 *
 * @extends AbstractPaymentMethodType
 */
final class Novalnet_Twint extends AbstractPaymentMethodType {
	/**
	 * Payment method name defined by payment methods extending this class.
	 *
	 * @var string
	 */
	protected $name = 'novalnet_twint';
