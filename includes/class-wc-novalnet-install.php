...
class WC_Novalnet_Install {
	...
	private static $db_updates = array(
		...
		'12.6.0'  => '',
		'12.6.1'  => '',
		'12.6.2'  => 'updates/novalnet-update-12.0.0.php',
	);
		...
		if ( version_compare( $current_db_version, NOVALNET_VERSION, '!=' ) ) {
			...
			if ( version_compare( $current_db_version, '12.0.0', '<' ) ) {
				...
				foreach ( self::$db_updates as $version => $updater ) {
					...
					if ( '' !== $updater && ( ! empty( $current_db_version ) && version_compare( $current_db_version, $version, '!=' ) && version_compare( $current_db_version, $version, '<' ) ) ) {
