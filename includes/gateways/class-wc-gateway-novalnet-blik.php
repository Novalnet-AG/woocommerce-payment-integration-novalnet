<?php
/**
 * Novalnet Blik Payment.
 *
 * This gateway is used for real time processing of Blik transaction of customers.
 *
 ...
 *
 * @class   WC_Gateway_Novalnet_Blik
...
/**
 * WC_Gateway_Novalnet_Blik Class.
 */
class WC_Gateway_Novalnet_Blik extends WC_Novalnet_Abstract_Payment_Gateways {
	...
	public function __construct() {
		...
		add_action( 'woocommerce_api_response_novalnet_blik', array( $this, 'check_novalnet_payment_response' ), 10 );
	}
