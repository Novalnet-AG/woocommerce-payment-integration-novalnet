...
class WC_Gateway_Novalnet_Instalment_Sepa extends WC_Novalnet_Abstract_Payment_Gateways {
	...
	public function __construct() {
		...
		novalnet()->helper()->unset_supports( 'refunds', $this->supports );
	}
	...
	public function is_available() {
		...
		return parent::is_available() && WC_Novalnet_Validation::is_payment_available( $this->settings, $this->id ) && WC_Novalnet_Validation::is_guarantee_available( $this->id, $this->settings ) && WC_Novalnet_Validation::has_valid_instalment_cycles( $this->settings, WC()->cart->total );
	}
