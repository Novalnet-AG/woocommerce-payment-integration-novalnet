 ...
 *
 * @class   WC_Gateway_Novalnet_Payconiq
...
/**
 * WC_Gateway_Novalnet_Payconiq Class.
 */
class WC_Gateway_Novalnet_Payconiq extends WC_Novalnet_Abstract_Payment_Gateways {
	...
	public function __construct() {
		...
		add_action( 'woocommerce_api_response_novalnet_payconiq', array( $this, 'check_novalnet_payment_response' ), 10 );
	}
