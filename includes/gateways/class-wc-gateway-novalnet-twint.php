 ...
 *
 * @class   WC_Gateway_Novalnet_Twint
...
/**
 * WC_Gateway_Novalnet_Twint Class.
 */
class WC_Gateway_Novalnet_Twint extends WC_Novalnet_Abstract_Payment_Gateways {
	...
	public function __construct() {
		...
		add_action( 'woocommerce_api_response_novalnet_twint', array( $this, 'check_novalnet_payment_response' ), 10 );
	}
