...
required for processing all international and local payments through this WooCommerce payment plugin. The plugin is available for WordPress versions 5.0 to 6.8.3, WooCommerce versions 4.0.0 to 10.3.4, and WooCommerce subscription versions 2.0.0 to 8.0.0 in the following languages: EN & DE.
