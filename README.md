...
required for processing all international and local payments through this WooCommerce payment plugin. The plugin is available for WordPress versions 5.0 to 6.9.1, WooCommerce versions 4.0.0 to 10.5.2, and WooCommerce subscription versions 2.0.0 to 8.4.0 in the following languages: EN & DE.
...
To test our demo shop, please visit: https://woocommercev12.novaldemo.com/
...
1. Download the WooCommerce payment plugin from <a href="https://wordpress.org/plugins/woocommerce-novalnet-gateway/"> here </a> or get it by <a href="https://www.novalnet.de/kontakt"> contacting us </a>
...
## Documentation
Find more about WooCommerce plugin in: [https://www.novalnet.de/site_pdf/Installation_Guide-wordpress_5.0-6.9.1_woocommerce_4.0.0-10.5.2_woo-subscription_2.0.0-8.4.0_novalnet_12.10.2.pdf](https://www.novalnet.de/site_pdf/Installation_Guide-wordpress_5.0-6.9.1_woocommerce_4.0.0-10.5.2_woo-subscription_2.0.0-8.4.0_novalnet_12.10.2.pdf)<br>
